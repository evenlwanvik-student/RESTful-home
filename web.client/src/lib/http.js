...
class HTTPClient {
    constructor() {
        this.client = axios.create({
            // ValidateStatus resolves promise is true
            validateStatus: () => true
        });
    }
    ...
    async request(args) {
        ...
        let rsp;  
         ...
         // Attempt a request to axios instance (not to be confused with this class function)
        try {
            console.log("inside http request, arsgs: ", args)
        ...
        // validate the status (200 <= status < 300)
